...
public class ShipSolution {
    ...
    public static String ShipNames[] = { "The Prairie Onion", "The Blackstrap", "The Bunnyhug", "The Salty Farmer", "The Icebreaker" }; // TODO Add more names!
     ...
     */
    public ShipSolution(String name, float capacity) {
    ...
    public boolean isOverloaded() {
        ...
        while (this.cargo.itemExists()) {
            totalCargoWeight += this.cargo.item().getWeight();
            this.cargo.goForth();
        }

        return totalCargoWeight > this.capacity;
    }
